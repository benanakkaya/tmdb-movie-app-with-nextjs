...
const CarauselCard = ({ movie, index }) => {


    return (
        <Link href={`/movie/${movie.id}`} className={`relative flex group w-full justify-center `}>

            <Tilt className={`w-full relative`} glareEnable={true} glareMaxOpacity={0.8} glareColor="#ffffff" glarePosition="all" glareBorderRadius="8px">
