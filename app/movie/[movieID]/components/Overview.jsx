...
const Overview = ({ movie }) => {
    return (
        <div className='bg-veryDark rounded-lg p-[20px] flex gap-4'>
            ...
            <div className='flex flex-col gap-4 text-white w-full'>
                <div className='flex items-center gap-2'>
                    <div className='flex flex-col justify-center gap-2'>
                        ...
                        <div className='flex items-center gap-2'>
                            <div className='text-xs text-white text-opacity-50'>Süre: <span className='text-white text-opacity-75'>{movie.runtime} dakika</span> </div>
